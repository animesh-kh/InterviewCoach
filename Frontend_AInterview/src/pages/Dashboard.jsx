...
const ALL_ROUNDS = [
  {
    ...
    items: [
      { icon: Code2, title: "Python & ML Basics", level: "entry" },
      { icon: Cpu, title: "Deep Learning", level: "mid" },
      { icon: Bug, title: "MLOps & Deployment", level: "senior" },
    ],
  },
  {
    category: "Django Developer",
    items: [
      { icon: Code2, title: "Django Basics", level: "entry" },
      { icon: Network, title: "REST APIs", level: "mid" },
      { icon: Cloud, title: "Scaling Django Apps", level: "senior" },
    ],
  },
  {
    category: "Full Stack Developer",
    items: [
      { icon: Globe, title: "Frontend Basics", level: "entry" },
      { icon: Code2, title: "React + Node", level: "mid" },
      { icon: Cloud, title: "System Design", level: "senior" },
    ],
  },
  {
    category: "Flutter Developer",
    items: [
      { icon: Code2, title: "Flutter Basics", level: "entry" },
      { icon: Cpu, title: "State Management", level: "mid" },
      { icon: Cloud, title: "App Deployment", level: "senior" },
    ],
  },
  {
    category: "iOS Developer",
    items: [
      { icon: Code2, title: "iOS Basics", level: "entry" },
      { icon: Cpu, title: "Advanced iOS", level: "mid" },
      { icon: Cloud, title: "iOS Architecture", level: "senior" },
    ],
  },
  {
    category: "Java Developer",
    items: [
      { icon: Code2, title: "Core Java", level: "entry" },
      { icon: Layers, title: "Spring Boot", level: "mid" },
      { icon: Cloud, title: "Microservices", level: "senior" },
    ],
  },
  {
    category: "JavaScript Developer",
    items: [
      { icon: Globe, title: "JS Basics", level: "entry" },
      { icon: Code2, title: "React + Node", level: "mid" },
      { icon: Cloud, title: "Scaling Apps", level: "senior" },
    ],
  },
  {
    category: "DevOps Engineer",
    items: [
      { icon: Cloud, title: "Linux + Docker", level: "entry" },
      { icon: Network, title: "Kubernetes", level: "mid" },
      { icon: Cpu, title: "CI/CD Pipelines", level: "senior" },
    ],
  },
  {
    category: "Software Engineer",
    items: [
      { icon: Code2, title: "Coding Round", level: "entry" },
      { icon: GitMerge, title: "DSA Round", level: "mid" },
      { icon: Cpu, title: "System Design", level: "senior" },
    ],
  },
  {
    category: "Database Administrator",
    items: [
      { icon: Database, title: "SQL Basics", level: "entry" },
      { icon: Database, title: "Performance Tuning", level: "mid" },
      { icon: Cloud, title: "Distributed DB", level: "senior" },
    ],
  },
];

// ✅ KEEP EVERYTHING SAME (your original design untouched)
      ...
      {filtered.map((section) => (
        <div key={section.category} className="mb-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {section.items.map(({ icon: Icon, title, level }) => (
              <div
                key={title}
