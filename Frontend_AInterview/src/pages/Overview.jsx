...
// ✅ UPDATED ROLE-BASED CATEGORIES (FINAL)
const CATEGORIES = [
  {
    label: "Machine Learning",
    accent: "#6366f1",
    rounds: [
      { title: "Python & ML Basics", icon: Code2 },
      { title: "Deep Learning", icon: Cpu },
      { title: "MLOps & Deployment", icon: BrainCircuit },
    ],
  },
  {
    ...
    accent: "#22d3ee",
    rounds: [
      { title: "Django Basics", icon: Code2 },
      { title: "REST APIs", icon: Network },
      { title: "Scaling Django Apps", icon: Cloud },
    ],
  },
  {
    ...
    accent: "#fb923c",
    rounds: [
      { title: "Frontend Basics", icon: Layout },
      { title: "React + Node", icon: Code2 },
  ...
  },
  {
    ...
    accent: "#ec4899",
    rounds: [
      { title: "Flutter Basics", icon: Code2 },
      { title: "State Management", icon: Cpu },
      { title: "App Deployment", icon: Cloud },
    ],
  },
  {
    ...
    accent: "#22c55e",
    rounds: [
      { title: "Core Java", icon: Code2 },
      { title: "Spring Boot", icon: Layers },
      { title: "Microservices", icon: Cloud },
    ],
  },
  {
    ...
    accent: "#a855f7",
    rounds: [
      { title: "JS Basics", icon: Globe },
      { title: "React + Node", icon: Code2 },
      { title: "Scaling Apps", icon: Cloud },
    ],
  },
  {
    ...
    accent: "#f43f5e",
    rounds: [
      { title: "Linux + Docker", icon: Cloud },
      { title: "Kubernetes", icon: Network },
      { title: "CI/CD Pipelines", icon: Settings },
    ],
  },
  {
  ...
  },
  {
    ...
    accent: "#eab308",
    rounds: [
      { title: "SQL Basics", icon: Database },
      { title: "Performance Tuning", icon: Database },
      { title: "Distributed DB", icon: Cloud },
    ],
  },
];
